...
export const WaterRiskReport = ({ data, analysisItems = [], controlDetails = [], executiveSummaryText, preparedBy, createdBy, riskTimelineData }: WaterRiskReportProps) => {
            ...
            return (
              <div key={index} className="bg-gray-50 p-2 rounded border border-gray-200 print-keep-together">
                ...
                {group.commonControls.length > 0 && (
                  <div className="mt-2.5 pt-1 border-t border-gray-200">
  ...
  const renderAppendixASection = (
    ...
    return (
      <div className="mb-4">
        <h3 className="text-sm font-bold text-gray-900 mb-1.5 border-b border-gray-200 pb-1.5">{title}</h3>
        <div className="space-y-3">
          {groups.map((group, index) => {
            const durationInfo = getDurationInfo(group.name, category);
            return (
  ...
  return (
    <div className="print-report bg-white text-black max-w-[210mm] mx-auto text-[12px] relative" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div className="print-header flex justify-between items-start mb-3.5 pb-2.5 border-b-2 border-gray-300">
        <div>
      ...
      <section className="mb-4">
        <h2 className="text-base font-bold text-gray-900 mb-1.5 border-b border-gray-300 pb-1.5">Executive Summary</h2>
        ...
        <div className="mb-3">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-gray-50 px-2 pt-2.5 pb-3.5 rounded border border-gray-200 flex flex-col items-center justify-center text-center gap-0.5">
